...
class EquipmentTab(ttk.Frame):
    ...
    class RulebookWeaponDialog(tk.Toplevel):
        ...
        def _setup_ui(self):
            ...
            ttk.Button(button_frame, text="Buy Weapon", command=lambda: self._on_select("buy")).pack(side=tk.LEFT,
                                                                                                     padx=5)
            ttk.Button(button_frame, text="Give Weapon", command=lambda: self._on_select("give")).pack(side=tk.LEFT,
                                                                                                       padx=5)
    ...
    class RulebookShieldDialog(tk.Toplevel):
        ...
        def _setup_ui(self):
            ...
            ttk.Button(button_frame, text="Buy Shield", command=lambda: self._on_select("buy")).pack(side=tk.LEFT,
                                                                                                     padx=5)
            ttk.Button(button_frame, text="Give Shield", command=lambda: self._on_select("give")).pack(side=tk.LEFT,
                                                                                                       padx=5)
            ttk.Button(button_frame, text="Cancel", command=self.destroy).pack(side=tk.RIGHT, padx=5)
